...
| ---------------- | --------------------------------- | -------- | ---------------------------------------------------------------------------------- |
| Exodus.Core      | Core components and abstractions. | 1.1.2-rc | [![Build Status](https://travis-ci.org/ninjah187/Exodus.svg?branch=configure-ci%2Fcore)](https://travis-ci.org/ninjah187/Exodus) |
